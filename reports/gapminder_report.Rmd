...
```
```{r gdp_lifeExp_1997_plot, echo=FALSE, fig.width=4, fig.height=3, fig.align='center'}
...
maxGDP <- gapminder_1997%>%
  ...
  pull()
```
The number of countries in the dataset is `r nCountries`. The minimum GDP is `r minGDP`, and the maximum GDP is `r maxGDP`.
